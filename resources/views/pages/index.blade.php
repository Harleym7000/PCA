              ...
              <div class="row justify-content-center">
                ...
                <div class="card" style="width: 25rem;">
                    ...
                    <div class="card-body">
                      ...
                      <a href="/events/{{$event->id}}" class="btn btn-primary">Find Out More <svg class="bi bi-arrow-bar-right" width="1.2em" height="1.2em" viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
