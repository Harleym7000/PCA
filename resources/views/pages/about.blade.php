...
<div id="about" class="mb-6">
    ...
    <h1 id="abt-heading" class="text-center mt-5 text-5xl text-blue-600 font-semibold">- What We Do -</h1>
    <p class="text-3xl mt-3 text-center">Portstewart Community Association is a charitable organisation which currently organises and implements The Red Sails Festival alongside other events and activities for the benefit of the community.</p>
...
<div class="max-w-md bg-white rounded-lg border border-gray-200 shadow-2xl shadow-gray-500 dark:bg-gray-800 dark:border-gray-700 mr-5 lg:mr-16">
    <a href="/red-sails">
        <img class="rounded-t-lg object-fill h-80 w-full border-solid border-4 border-slate-900" src="img/redsails.jpg" alt="" />
    </a>
    ...
    <div class="max-w-md bg-white rounded-lg border border-gray-200 shadow-2xl shadow-gray-500 dark:bg-gray-800 dark:border-gray-700 mr-5 lg:mr-16">
    <a href="/red-sails">
        <img class="rounded-t-lg object-fill h-80 w-full border-solid border-4 border-slate-900" src="img/event.jpg" alt="" />
    </a>
    ...
    <div class="max-w-md bg-white rounded-lg border border-gray-200 shadow-2xl shadow-gray-500 dark:bg-gray-800 dark:border-gray-700 mr-5 lg:mr-16">
    <a href="/red-sails">
        <img class="rounded-t-lg object-fill h-80 w-full border-solid border-4 border-slate-900" src="img/cleanup.jpg" alt="" />
    </a>
