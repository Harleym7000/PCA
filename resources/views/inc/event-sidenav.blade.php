<div id="sidenav">
  <div class="text-center">
    <div class="row">
      <img src="/img/pcaLogo.png" alt="" >
    <h1>PCA</h1>
  </div>
  <a href=""><div class="option">
  <svg class="bi bi-clipboard-data" viewBox="0 0 21 21" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<a href="/admin/users"><div class='option'>
  <svg class="bi bi-people" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
...
<a href="/admin/users/create"><div class='option'>
<svg class="bi bi-person-plus" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
...
<a href=""><div class='option'>
<svg class="bi bi-lock" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" style="margin-left: -2%; margin-right: 2%;">
  <path fill-rule="evenodd" d="M11.5 8h-7a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1zm-7-1a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-7zm0-3a3.5 3.5 0 1 1 7 0v3h-1V4a2.5 2.5 0 0 0-5 0v3h-1V4z"/>
</svg>
<p>Locked Accounts</p>
</div></a>
<a href="/admin/users/resetPass"><div class='option'>
  <svg class="bi bi-shield-lock" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" style="margin-left: -2%; margin-right: 2%;">
  ...
  <a href=""><div class="option">
    <svg class="bi bi-envelope-open" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" style="margin-left: -2%; margin-right: 2%;">
...
<a href=""><div class="option">
    <svg class="bi bi-file-earmark-text" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" style="margin-left: -3%; margin-right: 2%;">
  ...
  <a href="{{ route('logout') }}"
                      ...
                      <div class='option'>
   <svg class="bi bi-box-arrow-right" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" style="margin-left: -2%; margin-right: 2%;">
  ...
  <div class="resize">
    <div onclick="minimize()" class="row justify-content-center" style="margin-left: -145%;">
  <svg class="bi bi-arrow-bar-left" width="3em" height="3em" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg" >
