      <div id="sidenav">
        <div class="text-center">
          <div class="row">
            <img src="/img/pcaLogo.png" alt="" style="height: 100px; width: 130px;" class="pl-5">
          <h1>PCA</h1>
        </div>
        <div class="option">
      ...
      <div class='option'>
      <svg class="bi bi-person-check" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M11 14s1 0 1-1-1-4-6-4-6 3-6 4 1 1 1 1h10zm-9.995-.944v-.002.002zM1.022 13h9.956a.274.274 0 0 0 .014-.002l.008-.002c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664a1.05 1.05 0 0 0 .022.004zm9.974.056v-.002.002zM6 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm6.854.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L12.5 7.793l2.646-2.647a.5.5 0 0 1 .708 0z"/>
      </svg>
      <p>User Permissions</p>
      </div>
      <div class='option'>
      <svg class="bi bi-lock" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" d="M11.5 8h-7a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1zm-7-1a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h7a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-7zm0-3a3.5 3.5 0 1 1 7 0v3h-1V4a2.5 2.5 0 0 0-5 0v3h-1V4z"/>
      </svg>
      <p>Locked Accounts</p>
      </div>
      <div class='option'>
        <svg class="bi bi-shield-lock" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="option">
          <svg class="bi bi-envelope-open" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="option">
          <svg class="bi bi-file-earmark-text" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class='option'>
         <svg class="bi bi-box-arrow-right" viewBox="0 0 21 21" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="resize">
          <div onclick="minimize()" class="row justify-content-center" style="padding-right: 25%;">
